                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-1 mb-xl-0">
                            <div class="d-lg-flex align-items-center">
                                <div>
                                    <h2 class=" font-weight-medium text-black mb-2">Kategori Event</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>{{ $category->name }}</td>
                                                    <td>
                                                        <a href="{{ route('category-events.edit', $category->id) }}"
                                                            class="btn btn-success float-left mx-1">Edit</a>
                                                        <form
                                                            action="{{ route('category-events.destroy', $category->id) }}"
