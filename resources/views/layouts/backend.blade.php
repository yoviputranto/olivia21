...
<body>
    ...
    <aside class="position-fixed main-sidebar bg-white" id="sidebar">
        ...
        <div id="eventShow" class="collapse navbar-collapse">
            <a href="{{ url('user/riwayat') }}" class="text-purple sub-item">Draf</a>
            <a href="{{ url('user/riwayat') }}" class="text-purple sub-item">Aktif</a>
            <a href="{{ url('user/riwayat') }}" class="text-purple sub-item">Riwayat</a>
        </div>
