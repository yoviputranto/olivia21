  ...
  <nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img class="img-fluid" src="<?php echo e(url('frontend/assets/ic/logo-horizontal.png')); ?>" alt="logo" width="120px">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?php echo e(url('/')); ?>">Beranda</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item text-black" href="<?php echo e(url('/profile')); ?>">Sejarah</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('/program')); ?>">Event</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Diskusi
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item text-black" href="<?php echo e(url('/diskusi')); ?>">Timeline</a></li>
          ...
          <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle pt-1" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="img-fluid m-0" src="<?php echo e(url('frontend/assets/ic/logged-in-profile.png')); ?>" alt="" width="30px">
              </a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        ...
        <div class="box-container">
          <table class="element-container">
            <tbody><tr>
              ...
              <td>
                <a href="#">
                  <img class="search-img" src="<?php echo e(url('frontend/assets/ic/search-white.png')); ?>" width="14px" alt="search">
                </a>
              </td>
            </tr>
          </tbody></table>
        ...
        <a href="#" type="submit" class="btn btn-upload d-inline mt-4">
          <div class="row">
            ...
            <div class="col-5 d-flex justify-content-end">
              <img class="pt-1" src="<?php echo e(url('frontend/assets/ic/upload-svg.svg')); ?>" width="20px">        
            </div>
          </div>          
        </a>
      </div>
...
</html><?php /**PATH D:\Yovi\Kuliah\Lomba\olivia\Final\edumind\resources\views/user/upload.blade.php ENDPATH**/ ?>